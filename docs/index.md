---
page_title: "siteinfo-v1alpha1 Provider"
---

# siteinfo-v1alpha1 Provider

This provider is used to interact with the resources provided by the **siteinfo-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
