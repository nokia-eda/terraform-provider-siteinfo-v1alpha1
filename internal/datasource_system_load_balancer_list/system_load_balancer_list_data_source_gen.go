...
package datasource_system_load_balancer_list
...
func SystemLoadBalancerListDataSourceSchema(ctx context.Context) schema.Schema {
...
type SystemLoadBalancerListModel struct {
