...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-siteinfo/internal/datasource_banner"
...
const read_ds_banner = "/apps/siteinfo.eda.nokia.com/v1alpha1/namespaces/{namespace}/banners/{name}"

var (
	_ datasource.DataSource              = (*bannerDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*bannerDataSource)(nil)
)
...
func (d *bannerDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *bannerDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_banner, map[string]string{
...
func (r *bannerDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
