...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-siteinfo/internal/eda/utils"
...
var _ provider.Provider = (*siteinfoProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &siteinfoProvider{version: ver}
	}
}
...
func (p *siteinfoProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *siteinfoProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *siteinfoProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "siteinfo-v1alpha1"
	resp.Version = p.version
}

func (p *siteinfoProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewBannerDataSource,
		NewBannerListDataSource,
		NewDefaultMtuDataSource,
		NewDefaultMtuListDataSource,
		NewResourceListDataSource,
		NewSystemLoadBalancerDataSource,
		NewSystemLoadBalancerListDataSource,
	}
}

func (p *siteinfoProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewBannerResource,
		NewDefaultMtuResource,
		NewSystemLoadBalancerResource,
	}
}
