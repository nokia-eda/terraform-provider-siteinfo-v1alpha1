...
func BannerResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^Banner$"), ""),
				},
				Default: stringdefault.StaticString("Banner"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the Banner",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "BannerSpec allows the configuration of login and MOTD (Message of the Day) banners on selected nodes. The banners can be applied to specific nodes or selected using label selectors.",
			},
			"status": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"nodes": schema.ListAttribute{
						...
						MarkdownDescription: "List of nodes this banner has been applied to",
					},
				},
				...
				MarkdownDescription: "BannerStatus defines the observed state of Banner",
			},
		},
	}
}
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	loginBannerAttribute, ok := attributes["login_banner"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`login_banner is missing from object`)

		return nil, diags
	}

	loginBannerVal, ok := loginBannerAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`login_banner expected to be basetypes.StringValue, was: %T`, loginBannerAttribute))
	}
	...
	motdVal, ok := motdAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`motd expected to be basetypes.StringValue, was: %T`, motdAttribute))
	}
...
type SpecValue struct {
	...
	Motd         basetypes.StringValue `tfsdk:"motd"`
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["login_banner"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["motd"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.LoginBanner.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["login_banner"] = val
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.LoginBanner.Equal(other.LoginBanner) {
		return false
	}
