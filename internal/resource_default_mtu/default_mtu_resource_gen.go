...
func DefaultMtuResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^DefaultMTU$"), ""),
				},
				Default: stringdefault.StaticString("DefaultMTU"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the DefaultMTU",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				...
				Attributes: map[string]schema.Attribute{
					"interface_mtu": schema.Int64Attribute{
						...
						Validators: []validator.Int64{
							int64validator.Between(1500, 11000),
						},
					},
					"layer2_subif_mtu": schema.Int64Attribute{
						Optional:            true,
					...
					"layer3_mtu": schema.Int64Attribute{
						...
						Validators: []validator.Int64{
							int64validator.Between(1280, 11000),
						},
					},
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "DefaultMTUStatus defines the observed state of DefaultMTU",
			},
		},
	}
}

type DefaultMtuModel struct {
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	layer2SubifMtuAttribute, ok := attributes["layer2_subif_mtu"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`layer2_subif_mtu is missing from object`)

		return nil, diags
	}

	layer2SubifMtuVal, ok := layer2SubifMtuAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`layer2_subif_mtu expected to be basetypes.Int64Value, was: %T`, layer2SubifMtuAttribute))
	}

	layer3MtuAttribute, ok := attributes["layer3_mtu"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`layer3_mtu is missing from object`)

		return nil, diags
	}

	layer3MtuVal, ok := layer3MtuAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`layer3_mtu expected to be basetypes.Int64Value, was: %T`, layer3MtuAttribute))
	}
	...
	return SpecValue{
		...
		Layer2SubifMtu: layer2SubifMtuVal,
		Layer3Mtu:      layer3MtuVal,
...
type SpecValue struct {
	...
	Layer2SubifMtu basetypes.Int64Value `tfsdk:"layer2_subif_mtu"`
	Layer3Mtu      basetypes.Int64Value `tfsdk:"layer3_mtu"`
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["layer2_subif_mtu"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["layer3_mtu"] = basetypes.Int64Type{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.Layer2SubifMtu.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["layer2_subif_mtu"] = val

		val, err = v.Layer3Mtu.ToTerraformValue(ctx)
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			...
			"layer2_subif_mtu": basetypes.Int64Type{},
			"layer3_mtu":       basetypes.Int64Type{},
	...
	objVal, diags := types.ObjectValue(
		...
		map[string]attr.Value{
			...
			"layer2_subif_mtu": v.Layer2SubifMtu,
			"layer3_mtu":       v.Layer3Mtu,
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.Layer2SubifMtu.Equal(other.Layer2SubifMtu) {
		return false
	}

	if !v.Layer3Mtu.Equal(other.Layer3Mtu) {
		return false
	}
